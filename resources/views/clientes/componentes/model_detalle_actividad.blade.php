<div class="timeline-item">
    ...
    <div class="timeline-body">
        ...
        @elseif($actividad->causer_type == 'App\Models\User')
            Usuario <a href="{{ route('clientes.inicio') }}/{{ $actividad->causer_id }}"><span class="badge">#{{ $actividad->causer_id }}</span></a>
        @else
        ...
        @elseif($actividad->subject_type == 'App\Models\User')
            <br><b><i class="fa fa-fw fa-cube"></i> Objeto</b>: Usuario <a href="{{ route('clientes.inicio') }}/{{ $actividad->subject_id }}"><span class="badge">#{{ $actividad->subject_id }}</span></a>
        @endif
